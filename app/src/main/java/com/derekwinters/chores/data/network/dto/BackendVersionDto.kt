 ...
 * *backend's* own version/update status, unlike the removed `UpdateCheckStatusDto`/
 * `/v1/config/updates/*` endpoints this replaces, which this app previously (incorrectly) used to
 * represent its own version.
 */
@Serializable
